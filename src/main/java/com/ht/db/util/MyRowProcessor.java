...
public class MyRowProcessor implements RowProcessor {
     ...
     * constructor.
     */
    private static final MyBeanProcessor defaultConvert = new MyBeanProcessor();

    /**
     * Use this to process beans.
     */
    private final MyBeanProcessor convert;

    /**
     * MyRowProcessor constructor.  Bean processing defaults to a
    ...
    /**
     * MyRowProcessor constructor.
     * @param convert The BeanProcessor to use when converting columns to
     * bean properties.
     * @since DbUtils 1.1
     */
    public MyRowProcessor(MyBeanProcessor convert) {
        super();
